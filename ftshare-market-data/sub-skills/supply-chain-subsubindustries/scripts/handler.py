...
ENDPOINT = '/api/v3/market/data/supply-chain/subindustry-subsubindustries'
...
def main():
    key = _require_api_key(); parser = argparse.ArgumentParser(description='供应链子行业层级展开')
    parser.add_argument("--industry_name", required=True)
