...
|------|------|
| 接口名称 | 查询港股 K 线 |
| 外部接口 | `/api/v3/market/data/hk/hk-candlesticks` |
| 请求方式 | GET |
...
```
GET /api/v3/market/data/hk/hk-candlesticks?trade_code=00700.HK&interval_unit=day&since_date=2026-03-01&until_date=2026-03-24&limit=20
```
