...
ENDPOINT = '/api/v3/market/data/supply-chain/subsubindustry-parent-subindustries'
...
def main():
    key = _require_api_key(); parser = argparse.ArgumentParser(description='供应链子子行业父行业反查')
    parser.add_argument("--subindustry_name", required=True)
    args = parser.parse_args()
    params = {}
    if args.subindustry_name is not None: params["subindustry_name"] = args.subindustry_name
