...
def main():
    key=_require_api_key(); parser=argparse.ArgumentParser(description='期货主要品种交易周报')
    parser.add_argument("--week", dest="week")
    parser.add_argument("--prd", dest="prd")
    parser.add_argument("--start-week", dest="start_week")
    parser.add_argument("--end-week", dest="end_week")
