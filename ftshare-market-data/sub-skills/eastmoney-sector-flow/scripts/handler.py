...
ENDPOINT = '/api/v2/market/data/eastmoney-sector-flow'
...
def main():
    key = _require_api_key(); parser = argparse.ArgumentParser(description='东方财富板块资金流')
    parser.add_argument("--sector_code")
    parser.add_argument("--sector_type")
    ...
    params = {}
    if args.sector_code is not None: params["sector_code"] = args.sector_code
    if args.sector_type is not None: params["sector_type"] = args.sector_type
