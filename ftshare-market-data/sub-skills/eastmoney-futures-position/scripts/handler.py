...
def main():
    key=_require_api_key(); parser=argparse.ArgumentParser(description='东方财富期货持仓')
    parser.add_argument("--exchange", dest="exchange")
    parser.add_argument("--variety-code", dest="variety_code")
    ...
    parser.add_argument("--member-name-abbr", dest="member_name_abbr")
