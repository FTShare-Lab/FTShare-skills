...
ENDPOINT = '/api/v3/market/data/supply-chain/company-supply-chain-companies'
...
def main():
    key = _require_api_key(); parser = argparse.ArgumentParser(description='供应链公司候选')
    parser.add_argument("--trade_code", required=True)
