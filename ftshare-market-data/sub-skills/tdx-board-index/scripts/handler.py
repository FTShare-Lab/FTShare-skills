...
def main():
    ...
    parser.add_argument("--rise_speed", required=True)
    parser.add_argument("--pre_close", required=True)
    parser.add_argument("--lead_market", required=True)
    parser.add_argument("--lead_code", required=True)
    parser.add_argument("--lead_name", required=True)
    parser.add_argument("--lead_price", required=True)
