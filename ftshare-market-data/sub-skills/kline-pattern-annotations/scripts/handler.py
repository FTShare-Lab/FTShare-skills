...
ENDPOINT = '/api/v3/market/data/kline-pattern-annotations'
...
def main():
    key = _require_api_key(); parser = argparse.ArgumentParser(description='K线形态标注')
    ...
    if args.pattern is not None: params["pattern"] = args.pattern
