...
def main():
    ...
    parser.add_argument("--row_no", required=True)
    parser.add_argument("--holder_name", required=True)
    parser.add_argument("--holder_rank", required=True)
    ...
    parser.add_argument("--updated_at", required=True)
