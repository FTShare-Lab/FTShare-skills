...
def main():
    ...
    parser.add_argument("--ann_date", required=True)
    parser.add_argument("--reporting_period", required=True)
    parser.add_argument("--cash_dividend_ratio", required=True)
    parser.add_argument("--bonus_issue_ratio", required=True)
    parser.add_argument("--bonus_issue_from_capital_reserves_ratio", required=True)
    parser.add_argument("--ex_dividend_date", required=True)
    parser.add_argument("--ann_url", required=True)
