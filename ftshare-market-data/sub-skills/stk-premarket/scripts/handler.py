...
ENDPOINT = '/api/v2/market/data/stk-premarket'
...
def main():
    key = _require_api_key(); parser = argparse.ArgumentParser(description='盘前数据')
    ...
    parser.add_argument("--pre_close")
    parser.add_argument("--up_limit")
    parser.add_argument("--down_limit")
    parser.add_argument("--price")
    parser.add_argument("--total_mv")
    parser.add_argument("--float_mv")
    args = parser.parse_args()
    params = {}
    for name in ("ts_code", "trade_date", "start_date", "end_date", "page", "page_size"):
