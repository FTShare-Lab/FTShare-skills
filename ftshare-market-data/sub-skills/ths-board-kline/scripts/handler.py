...
ENDPOINT = '/api/v2/market/data/ths-board-kline'
...
def main():
    key = _require_api_key(); parser = argparse.ArgumentParser(description='同花顺板块K线')
    parser.add_argument("--board_code", required=True)
    parser.add_argument("--page")
    parser.add_argument("--page_size")
    args = parser.parse_args()
    params = {}
    if args.board_code is not None: params["board_code"] = args.board_code
