...
<img src="docs/assets/wechat-group-20260805.png" alt="FTShare WeChat community group" width="320" />
...
**The QR code is valid until August 5, 2026.** If it expires, please open an Issue and the maintainers will update the invitation.
